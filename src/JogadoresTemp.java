...
public class JogadoresTemp {
    ...
    */
    ...
    public JogadoresTemp(String nome, int velocidade, int resistencia, int destreza,
    ...
    public JogadoresTemp(JogadoresTemp jog){
    ...
    public JogadoresTemp clone(){ return new JogadoresTemp(this);}


    public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        JogadoresTemp jogadores = (JogadoresTemp) o;
